...
public extension NetworkClient {
    ...
    func zip<A: Endpoint, B: Endpoint>(_ a: A, _ b: B) async throws -> (A.Response, B.Response) {
    ...
    func zip<A: Endpoint, B: Endpoint, C: Endpoint>(
        _ a: A, _ b: B, _ c: C
    ...
    func batch<E: Endpoint>(_ endpoints: [E]) async -> [Result<E.Response, NetworkError>] {
