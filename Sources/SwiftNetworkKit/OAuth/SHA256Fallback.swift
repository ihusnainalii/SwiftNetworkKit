...
/// Pure-Swift SHA-256 (FIPS 180-4). Used only on platforms without CryptoKit (Linux) so the
/// package keeps its zero-dependency promise. On Apple platforms `CryptoKit.SHA256` is used instead.
enum SHA256Fallback {
